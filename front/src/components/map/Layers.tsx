...
export const Layers = ({
  ...
  setActiveTechnicalLayer,
  hydrantsVisible,
  setHydrantsVisible,
  incidenciesVisible,
  setIncidenciesVisible,
  baseLayer,
  setBaseLayer,
  positions,
  trackingChecked,
  ...
  useMapEvents({
    ...
    overlayadd: (e) => {
      if (e.name === "Posicions OwnTracks") {
        setTrackingChecked(true);
        return;
      }
      if (e.name === "Hidrants") {
        setHydrantsVisible(true);
        return;
      }
      if (e.name === "Incidències") {
        setIncidenciesVisible(true);
        return;
      }
    ...
    overlayremove: (e) => {
      ...
      if (e.name === "Hidrants") {
        setHydrantsVisible(false);
        return;
      }
      if (e.name === "Incidències") {
        setIncidenciesVisible(false);
        return;
      }
  ...
  return (
    <LayersControl position="topright">
      ...
      <LayersControl.Overlay checked={incidenciesVisible} name="Incidències">
        <LayerGroup />
      </LayersControl.Overlay>
      <LayersControl.Overlay checked={hydrantsVisible} name="Hidrants">
        <LayerGroup />
      </LayersControl.Overlay>
      {user && (
        <LayersControl.Overlay checked={trackingChecked} name="Posicions OwnTracks">
          <TrackingLayer positions={positions} />
        </LayersControl.Overlay>
      )}
    </LayersControl>
  );
